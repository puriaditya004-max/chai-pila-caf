...
// ── DEFAULT DATA INSERT (agar nahi hai to) ──
...
// ── SAFE MIGRATIONS (purana database ke liye — column already exist to ignore) ──
const migrations = [
  ...
  `ALTER TABLE orders ADD COLUMN delivery_fee REAL DEFAULT 20`,
